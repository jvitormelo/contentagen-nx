...
export interface FooterOneContent {
   homeLink: string;
   links: Array<{
      title: string;
      href: string;
      ...
      <footer className="bg-muted py-16">
         <div className="mx-auto max-w-5xl px-6">
            <a
               ...
               href={mergedContent.homeLink}
            >
               <Logo />
            </a>

            <div className="my-8 flex flex-wrap justify-center gap-6">
               {mergedContent.links.map((link, index) => (
                  <a
            ...
            <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
               {mergedContent.socialLinks.map((social, index) => (
                  <a
                  ...
                  >
                     <svg
                        className="size-6"
                        height="1em"
                        viewBox={social.svgViewBox || "0 0 24 24"}
                        width="1em"
                        xmlns="http://www.w3.org/2000/svg"
                     >
                        <path
                           color={social.svgColor}
                           d={social.svgPath}
                           fill={social.svgColor ? "none" : "currentColor"}
                           stroke={social.svgColor ? "currentColor" : undefined}
                           strokeLinecap={social.svgColor ? "round" : undefined}
                           strokeLinejoin={
                              social.svgColor ? "round" : undefined
                           }
                           strokeWidth={social.svgStrokeWidth}
                        ></path>
                     </svg>
                  </a>
               ))}
